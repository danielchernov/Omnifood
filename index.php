      ...
      <div class="row js--wp-3">
        <div class="col span-1-of-4 box">
          ...
          <div class="city-feature">
            <i class="ion-ios-person icon-small">1600+ happy eaters</i>
          </div>
          <div class="city-feature">
            <i class="ion-ios-star icon-small">60+ top chefs</i>
          </div>
          <div class="city-feature">
        ...
        <div class="col span-1-of-4 box">
          ...
          <h3>San Francisco</h3>
          <div class="city-feature">
            <i class="ion-ios-person icon-small">3700+ happy eaters</i>
          </div>
          <div class="city-feature">
            <i class="ion-ios-star icon-small">160+ top chefs</i>
          </div>
          <div class="city-feature">
            <i class="ion-social-twitter icon-small"></i
        ...
        <div class="col span-1-of-4 box">
          ...
          <h3>Berlin</h3>
          <div class="city-feature">
            <i class="ion-ios-person icon-small">2300+ happy eaters</i>
          </div>
          <div class="city-feature">
            <i class="ion-ios-star icon-small">110+ top chefs</i>
          </div>
          <div class="city-feature">
            <i class="ion-social-twitter icon-small"></i
        ...
        <div class="col span-1-of-4 box">
          ...
          <h3>London</h3>
          <div class="city-feature">
            <i class="ion-ios-person icon-small">1200+ happy eaters</i>
          </div>
          <div class="city-feature">
            <i class="ion-ios-star icon-small">50+ top chefs</i>
          </div>
          <div class="city-feature">
            <i class="ion-social-twitter icon-small"></i
      ...
      <div class="row">
        <div class="col span-1-of-3">
          <blockquote>
            ...
            <cite
              ><img
                src="resources/css/img/customer-1.jpg"
                alt="Customer Photo"
              />Alberto Duncan</cite
            >
          </blockquote>
        ...
        <div class="col span-1-of-3">
          <blockquote>
            ...
            <cite
              ><img
                src="resources/css/img/customer-2.jpg"
                alt="Customer Photo"
              />Joana Silva</cite
            >
          </blockquote>
        ...
        <div class="col span-1-of-3">
          <blockquote>
            ...
            <cite
              ><img
                src="resources/css/img/customer-3.jpg"
                alt="Customer Photo"
              />Milton Chapman</cite
            >
          </blockquote>
